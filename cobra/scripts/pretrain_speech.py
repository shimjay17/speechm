...
def pretrain(cfg: PretrainConfig) -> None:
    ...
    train_dataset, eval_dataset, collator = get_dataset_and_collator(
        cfg.stage,
        cfg.dataset,
        tokenizer=tokenizer,
    ...
    # for fast evaluation
    eval_dataset = torch.utils.data.Subset(eval_dataset, range(1000))
    ...
    train_strategy.run_training(train_dataset, eval_dataset, collator, metrics, stage=cfg.stage, seed=cfg.seed)
