...
def run_training(
        ...
        chosen_loader = giga_dataloader if giga_dataset else libri_dataloader
        ...
        steps_per_epoch = len(chosen_loader) // self.grad_accumulation_steps
        ...
        with tqdm(
            total=(
                (self.epochs * len(chosen_loader) // self.grad_accumulation_steps)
            ...
            for epoch in range(self.epochs):
                ...
                for train_idx, libri_batch in enumerate(chosen_loader):
                    if giga_dataset:
                        # Get Giga Batch
                        try:
                    ...
                    #     else:
                    #         giga_loss = (giga_loss * giga_batch_size)/(giga_batch_size)
                    ...
                    # if libri_dataset:
                    #     loss = libri_loss
                    # elif libri_dataset and giga_dataset:
                    #     loss = giga_loss + libri_loss
                    loss = libri_loss
