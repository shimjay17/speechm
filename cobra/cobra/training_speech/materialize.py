...
Factory class defining functions for instantiating various Training Strategies, supporting different SLMs, backbones,
...
from cobra.training_speech.strategies import FSDPStrategy, TrainingStrategy
