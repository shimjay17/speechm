...
train_clean_100_path = '/data2/data_account/workspace/data/LibriSpeech/train-clean-100'
train_clean_360_path = '/data2/data_account/workspace/data/LibriSpeech/train-other-360'
train_other_500_path = '/data2/data_account/workspace/data/LibriSpeech/train-other-500'
dev_clean_path = '/data2/data_account/workspace/data/LibriSpeech/dev-clean'
dev_other_path = '/data2/data_account/workspace/data/LibriSpeech/dev-other'
test_clean_path = '/data2/data_account/workspace/data/LibriSpeech/test-clean'
test_other_path = '/data2/data_account/workspace/data/LibriSpeech/test-other'
...
# save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/train.pkl'
# save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/train.json'
# save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/eval.pkl'
# save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/eval.json'
# save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/test.pkl'
save_file_name = '/data2/data_account/workspace/samsung/speech_summarization_mamba/cobra/data/librispeech/test.json'
