...
class CobraSLM(SLM):
    def __init__(
        ...
        if arch_specifier == "linear":
            ...
            self.projector = SimpleQMambaProjector(speech_backbone.embed_dim, llm_backbone.embed_dim, query_length=1)
    ...
    def forward(
        ...
        with torch.set_grad_enabled(self.speech_backbone_requires_grad):
            if isinstance(input_values, dict):
                ...
                speech_embeddings = self.speech_backbone(input_values=input_values).last_hidden_state # TODO
