...
class CobraSLM(SLM):
    ...
    def forward(
        ...
        input_values: Optional[List[torch.FloatTensor]] = None,
        ...
        with torch.set_grad_enabled(self.speech_backbone_requires_grad):
            if isinstance(input_values, dict):
                ...
                speech_embedding_list = []
                for input_values_item in input_values:
                    speech_embeddings = self.speech_backbone(input_values=input_values_item).last_hidden_state
        
                    # =============================================================================================================
                    if self.arch_specifier.endswith("qmamba"):
                    # downsampling (e.g., windowing) with F.unfold
                    # referenced from salmonn (https://github.com/bytedance/SALMONN/blob/b82a490f8f860e9454de295eea4317a8b6d9d558/models/salmonn.py#L219)
                    ...
                    speech_embedding_list.append(projected_speech_embeddings)
        ...
        projected_speech_embeddings_cat = torch.cat(speech_embedding_list, dim=1)
        multimodal_embeddings = torch.cat(
            [
                speech_start_embedding,
                projected_speech_embeddings_cat,
